        ...
        <div className={styles.icons}>
          ...
          <IconLink href={blog} label="博客">
            <svg
              ...
              className={styles.icon}
            >
              <path d="M12 0C5.372 0 0 5.372 0 12c0 6.628 5.372 12 12 12 6.628 0 12-5.372 12-12 0-6.628-5.372-12-12-12zm0 21.82c-5.41 0-9.82-4.41-9.82-9.82 0-5.41 4.41-9.82 9.82-9.82 5.41 0 9.82 4.41 9.82 9.82 0 5.41-4.41 9.82-9.82 9.82zM8.938 7.47h-1.563v8.752h1.563v-8.752zm6.123 0h-1.562v5.847a1.883 1.883 0 01-1.937 1.87 1.915 1.915 0 01-1.968-1.77v-5.947H9.78v6.07c0 1.868 1.531 3.406 3.438 3.406 1.937 0 3.375-1.438 3.375-3.406v-6.07h-.632z" />
            </svg>
          </IconLink>
